...
class TestCondOps:
    ...
    def test_range(self):
        ...
        m3pm4 = Expr[3 + Expr[4]]
        m6pm7 = Expr[6 + Expr[7]]
        m3pm4lt5 = Less(m3pm4, 5)
        m6pm7lt5 = Less(m6pm7, 5)
        m3pm4le5 = LessOrEqual(m3pm4, 5)
        m6pm7le5 = LessOrEqual(m6pm7, 5)
        m3pm4e5 = Equal(m3pm4, 5)
        m6pm7e5 = Equal(m6pm7, 5)
        m3pm4ge5 = GreaterOrEqual(m3pm4, 5)
        m6pm7ge5 = GreaterOrEqual(m6pm7, 5)
        m3pm4gt5 = Greater(m3pm4, 5)
        m6pm7gt5 = Greater(m6pm7, 5)
    ...
    def test_conjunction(self):
        ...
        m1lt5 = Less(Expr[1], 5)
        m1le5 = LessOrEqual(Expr[1], 5)
        m1e5 = Equal(Expr[1], 5)
        m1ne5 = NotEqual(Expr[1], 5)
        m1ge5 = GreaterOrEqual(Expr[1], 5)
        m1gt5 = Greater(Expr[1], 5)
